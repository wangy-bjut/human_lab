...
from human_lab.humanlab_assets import HUMANLAB_ASSETS_DIR
...
G1_LEG_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{HUMANLAB_ASSETS_DIR}/g1/g1.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
            disable_gravity=False,
            retain_accelerations=False,
    ...
    soft_joint_pos_limit_factor=0.90,    #1.0

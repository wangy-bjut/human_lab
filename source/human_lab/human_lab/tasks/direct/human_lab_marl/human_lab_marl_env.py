...
from .human_lab_marl_env_cfg import HumanLabMarlEnvCfg


class HumanLabMarlEnv(DirectMARLEnv):
    cfg: HumanLabMarlEnvCfg

    def __init__(self, cfg: HumanLabMarlEnvCfg, render_mode: str | None = None, **kwargs):
